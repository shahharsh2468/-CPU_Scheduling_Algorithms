		...
		<table border="0" cellspacing="50px" align="center">
			...
			<tr>
				<td colspan="3" align="center" id="topmovietitle">
					<h3>NON PREEMPTIVE PRIORITY</h3>
					 <hr size="3" width="135" color="#94c82f" align="center"/>
				</td>
			</tr>
<tr>
    
<th id="a1"><h3>Number of Processs:</h3><br></th>
    <th><h3><input type="text" name="count" id="count" placeholder="count" value="<?php echo $count; ?>"><br><br></h3>
    </th>
    <th><h3><input type="submit" id="submit" placeholder="submit" name="submit" value="Submit"></h3>
<br></th>
</tr>
...
<br>
    ...
    <h3 id="h3">Average Waiting Time: "<?php echo $AWT; ?>" </h3><br>  
        ...
        <tr>
            ...
            <th id="a1"><h3>Priority Number</h3></th>
        ...
        <tr>
            ...
            <th id="a4"><h3><?php echo $Process[$x][6]; ?></h3></th>
 ...
 <?php }} else { ?>
        ...
        <tr>
            <th id="a4"><h3>ProcessID</h3></th>
            <th id="a4"><h3>Arrival Time</h3></th>
            <th id="a4"><h3>Burst Time</h3></th>
            <th id="a4"><h3>Priority Number</h3></th>
        </tr>
        <?php
        for($x=1;$x<=$count;$x++)
        {
 ...
 <?php }} ?>
     <tr>
         <th></th>
     <th><h3><input type="submit" name="solve" id="solve" placeholder="solve" value="Solve"></h3><br></th>
     </tr>
     </form>
         </table>
        </div>
