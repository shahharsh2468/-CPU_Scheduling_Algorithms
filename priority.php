...
if($flag==1)
 	...
 	while($completed != $count) 
	{
        	...
        	$mx = -1;	
		for($i = 1; $i <= $count; $i++) {
            		if($Process[$i][2] <= $current_time && $is_completed[$i] == 0) 
			{
                		if($Process[$i][6] > $mx) 
				{
                    			$mx = $Process[$i][6];
		...
		if($idx != -1) 
		{
            		if($burst_remaining[$idx] == $Process[$idx][1]) 
			{
			...
			{
                		$Process[$idx][3] = $current_time;
                		$Process[$idx][4] = $Process[$idx][3] - $Process[$idx][2];
                		$Process[$idx][5] = $Process[$idx][4] - $Process[$idx][1];
...
<br>
 ...
 <?php }} else { ?>
	...
	<th><input type="text" id="pp<?php echo $x; ?>" name="pp<?php echo $x; ?>" placeholder="pp<?php echo $x; ?>"></th>
        </tr>
 <?php }} ?>
 <tr>
     <th> </th>
